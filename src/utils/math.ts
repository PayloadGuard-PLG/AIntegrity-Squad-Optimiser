...
export const TIER_DATA: { name: TierName; attrAddition: number; pointsRequired: number }[] = [
  ...
  { name: 'Elite',     attrAddition: 30,  pointsRequired: 300 },
  { name: 'Stellar',   attrAddition: 50,  pointsRequired: 600 },
  { name: 'Master',    attrAddition: 80,  pointsRequired: 1000 },
  { name: 'Epic',      attrAddition: 120, pointsRequired: 1500 },
  { name: 'Legendary', attrAddition: 160, pointsRequired: 2100 },
];
