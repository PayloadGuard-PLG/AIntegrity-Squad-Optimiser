...
export const DRILL_LIST: Drill[] = [
  ...
  { name: 'Use Your Head',          type: 'Attack',   stats: ['HEADING', 'STRENGTH', 'POSITIONING'],              baseLoss: 1.5,  isBase: false },
  ...
  { name: 'Stop the Attacker',      type: 'Defence',  stats: ['TACKLING', 'MARKING', 'BRAVERY'],                  baseLoss: 2.25, isBase: false },
