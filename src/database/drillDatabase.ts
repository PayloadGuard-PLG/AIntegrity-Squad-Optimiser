...
export const DRILL_LIST: Drill[] = [
  ...
  { name: 'Target Practice',     type: 'Attack',   stats: ['SHOOTING', 'STRENGTH', 'REFLEXES'],                           baseLoss: 2.25, intensity: 'Medium',    isBase: true },
  { name: 'Break Away',          type: 'Attack',   stats: ['CROSSING', 'PASSING', 'FINISHING', 'CREATIVITY'],             baseLoss: 3.75, intensity: 'Very Hard', isBase: true },
  ...
  { name: 'Cone Weave',          type: 'Attack',   stats: ['DRIBBLING', 'SPEED', 'AGILITY'],                              baseLoss: 1.5,  intensity: 'Hard',      isBase: false },
  ...
  { name: 'Build-Up Play',       type: 'Attack',   stats: ['POSITIONING', 'CREATIVITY', 'FINISHING', 'PASSING', 'ANTICIPATION'], baseLoss: 2.5, intensity: 'Hard', isBase: false },
  { name: 'Attack Blueprint',    type: 'Attack',   stats: ['PASSING', 'DRIBBLING', 'CROSSING', 'SHOOTING', 'FINISHING'],  baseLoss: 3.5,  intensity: 'Very Hard', isBase: false },
  ...
  { name: 'Box Clearance',       type: 'Defence',  stats: ['HEADING', 'POSITIONING', 'MARKING'],                          baseLoss: 1.5,  intensity: 'Medium',    isBase: false },
  { name: 'Compact Block',       type: 'Defence',  stats: ['POSITIONING', 'BRAVERY', 'MARKING'],                          baseLoss: 1.5,  intensity: 'Easy',      isBase: false },
  { name: 'High Press',          type: 'Defence',  stats: ['AGGRESSION', 'POSITIONING', 'MARKING', 'BRAVERY', 'TACKLING'], baseLoss: 2.5, intensity: 'Hard',      isBase: false },
  { name: 'GK Protocol',         type: 'Defence',  stats: ['AGILITY', 'AERIAL REACH', 'THROWING', 'KICKING', 'REFLEXES'], baseLoss: 2.5, intensity: 'Hard',      isBase: false },
  { name: 'Wide Switch',         type: 'Defence',  stats: ['COMMUNICATION', 'POSITIONING', 'CREATIVITY', 'CROSSING', 'PASSING', 'SPEED'], baseLoss: 1.75, intensity: 'Medium', isBase: false },
  { name: 'Channel Hold',        type: 'Defence',  stats: ['POSITIONING', 'AERIAL REACH', 'SPEED', 'FITNESS'],            baseLoss: 1.75, intensity: 'Medium',    isBase: false },
  { name: 'Physical Duel',       type: 'Defence',  stats: ['DRIBBLING', 'STRENGTH', 'MARKING', 'BRAVERY', 'AGGRESSION'], baseLoss: 1.75, intensity: 'Medium',    isBase: false },
  { name: 'Defence Blueprint',   type: 'Defence',  stats: ['TACKLING', 'MARKING', 'POSITIONING', 'HEADING', 'BRAVERY'],  baseLoss: 3.5,  intensity: 'Very Hard', isBase: false },

  // --- Physical ---
  { name: 'Weight Room',         type: 'Physical', stats: ['STRENGTH', 'FITNESS', 'KICKING', 'THROWING'],                 baseLoss: 4.5,  intensity: 'Very Hard', isBase: true },
  { name: 'Speed Work',          type: 'Physical', stats: ['FITNESS', 'SPEED', 'DRIBBLING', 'RUSHING OUT'],               baseLoss: 2.25, intensity: 'Very Hard', isBase: true },
  ...
  { name: 'Interval Runs',       type: 'Physical', stats: ['SPEED', 'FITNESS', 'STAMINA'],                                baseLoss: 2.25, intensity: 'Hard',      isBase: false },
  { name: 'Plyometrics',         type: 'Physical', stats: ['AGILITY', 'SPEED', 'STRENGTH'],                               baseLoss: 1.5,  intensity: 'Hard',      isBase: false },
];
