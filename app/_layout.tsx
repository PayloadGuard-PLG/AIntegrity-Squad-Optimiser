...
// Privacy overlay — shown when app is backgrounded or in the task switcher.
// Prevents OS screenshot capture from exposing squad data in the app switcher.
...
// Minimal StyleSheet-style helper (avoids importing StyleSheet just for absoluteFillObject)
const StyleSheet = {
  absoluteFillObject: {
...
function usePrivacyOverlay() {
  ...
  useEffect(() => {
    const sub = AppState.addEventListener('change', (next: AppStateStatus) => {
      ...
      // Show overlay as soon as app leaves foreground (catches task switcher screenshot)
      if (next === 'inactive' || next === 'background') {
        setObscured(true);
      }
      // Hide overlay once fully active again
