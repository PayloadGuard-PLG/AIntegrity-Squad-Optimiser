...
GK:  white(7)=[REFLEXES,ANTICIPATION,RUSHING OUT,COMMUNICATION,KICKING,AERIAL REACH,FITNESS]
     grey(8)= [AGILITY,THROWING,PUNCHING,CONCENTRATION,STRENGTH,AGGRESSION,SPEED,CREATIVITY]
