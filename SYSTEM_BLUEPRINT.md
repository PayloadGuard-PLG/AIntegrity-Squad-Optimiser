...
| Base XP per session | `baseXpPerSession` | 676 | ⚠️ Admissible, not identified — back-calculated from Grant ×40 Defending and Dallas ×4 Safeguard, but those observations admit 675–930; 676 sits near the lower edge |
